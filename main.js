$(function () {
  ...
  function send() {
    ...
    isInArray(hello, lastmsg) == true
      ...
      ? ((smsg =
          "Thanks for checking my social media platforms.If you loved my content I kindly request you to like, subscribe & follow our social platforms @aditikute24 "),
        (k = smsg),
        setTimeout(function () {
          $(".status").html("last seen today at " + time);
        }, 6000),
      ...
      : ((smsg =
          "Sorry, I didn't understand, please explain it with proper spellings or  If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search aditikute24</b>"),
        (k =
          "Sorry, I didn't understand, please explain it, with proper spellings, or  If you say, so I can search for you. To search,type,Search Your keyword,for example, type, Search aditikute24 "));
    para = $(
